namespace JanHafner.Smartbar.Views.Group
{
    ...
    internal sealed class GroupViewModelDeleteCommand : DelegateCommand
    {
        public GroupViewModelDeleteCommand(GroupViewModel groupViewModel, ISmartbarSettings smartbarSettings,  IWindowService windowService, ICommandDispatcher commandDispatcher)
            : base(async () =>
            {
